...
\fi
\ifshowtranssecond %(校正)
\chapter{ 順序回路ブロック (L5709 TODO)} %(校正 12/06 aki 第6章  ========================================================================)
\fi
...
\ifshowtranssecond %(校正 12/06 aki)
...
\fi
\ifshowtranssecond %(校正)
\section{レジスター (L5743 校正 12/06 aki)}
\fi
...
\fi
\ifshowtranssecond %(校正)
\subsection{カウントアップとダウン (L6268 12/06 aki}
\fi
