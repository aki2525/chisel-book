...
\fi
\ifshowtrans %(校正)
\chapter{Chiselへの貢献 (L10543)} % (校正 7/24 mune10 13章初回終了 =======================================================)
\fi
...
\ifshowtrans %(校正 7/23 mune10)
ローカルに公開されたバージョンの Chisel を参照するように\code{build.sbt}を変更します。
さらに、この本の執筆時点では、Chiselのソースコードのヘッドは、Scalaの2.12を使用しています。
しかし、Scala 2.12 は\myref{https://github.com/freechipsproject/chisel-template/issues/35}{anonymous bundles}の問題を持っています。
